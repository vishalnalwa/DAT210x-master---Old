...
#
column_names = ['education', 'age', 'capital-gain', 'race', 'capital-loss', 'hours-per-week', 'sex', 'classification']
df=pd.read_csv('Datasets/census.data' , header=-1, names=column_names, na_values='?')
#df=pd.read_csv('Datasets/census.data' , header=-1, names=column_names)
