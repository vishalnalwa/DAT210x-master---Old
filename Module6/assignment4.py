...
#
# TODO: Create an Deciiosn Tree  classifier, setting its max_depth to 9, and random_state=2
#
# .. your code here ..

decisionTree = tree.DecisionTreeClassifier(max_depth=1, random_state=7)
#
...
benchmark(decisionTree, X_train, X_test, y_train, y_test, 'Decision Tree')
drawPlots(decisionTree, X_train, X_test, y_train, y_test, 'Decision Tree')
