...
#
# .. your code here ..
X=pd.read_csv('Datasets/College.csv',index_col=0,header=0)
...
# score variable.
#
X_train, X_test , y_train , y_test = train_test_split(X_room,y,test_size = 0.30 , random_state=7)
...
# score variable.
#
X_train, X_test , y_train , y_test = train_test_split(X_enroll,y,test_size = 0.30 , random_state=7)
model.fit(X_train,y_train)
linear_model.LinearRegression(copy_X=True, fit_intercept=True, n_jobs=1, normalize=False)
score = model.score(X_test, y_test)
# INFO: We'll take it from here, buddy:
...
#
X_undergrad = X[["F.Undergrad"]]
#
# TODO: Fit and score your model appropriately. Store the score in the
# score variable.
#
X_train, X_test , y_train , y_test = train_test_split(X_undergrad,y,test_size = 0.30 , random_state=7)
model.fit(X_train,y_train)
linear_model.LinearRegression(copy_X=True, fit_intercept=True, n_jobs=1, normalize=False)
score = model.score(X_test, y_test)
# INFO: We'll take it from here, buddy:
...
#
# .. your code here ..
X_multi = X[["Room.Board","Enroll"]]

#
# TODO: Fit and score your model appropriately. Store the score in the
# score variable.
#
X_train, X_test , y_train , y_test = train_test_split(X_multi,y,test_size = 0.30 , random_state=7)
model.fit(X_train,y_train)
linear_model.LinearRegression(copy_X=True, fit_intercept=True, n_jobs=1, normalize=False)
score = model.score(X_test, y_test)
# INFO: We'll take it from here, buddy:
