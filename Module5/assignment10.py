...
directory = 'Datasets/audio'

for filename in os.listdir(directory):
    if filename.endswith(".wav"): 
        #x=wavfile.read(os.path.join(directory, filename))[1]
        #print x
        #print wavfile.read(os.path.join(directory, filename))[1]
        zero.append(wavfile.read(os.path.join(directory, filename))[1])
        continue
    else:
        continue
# 
...
zero = pd.DataFrame.from_dict(zero, dtype=np.int16)
...
wavfile.write('xtest.wav', sample_rate, X_test)
wavfile.write('ytest.wav', sample_rate, y_test)
...
wavfile.write('xtrain.wav', sample_rate, X_train)
wavfile.write('ytrain.wav', sample_rate, y_train)
# 
...
wavfile.write('y_test_prediction.wav', sample_rate, y_test_prediction[0])
# 
