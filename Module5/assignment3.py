...
#
unique_numbers = users = df.In.unique()
...
#
user1 = df[(df['In']==unique_numbers[0])& ((df['DOW']=='Mon') | (df['DOW']=='Tue') |(df['DOW']=='Wed') | (df['DOW']=='Thr')| (df['DOW']=='Fri'))]
...
user1.plot.scatter(x='TowerLon', y='TowerLat', c='gray', alpha=0.9, title='Call Locations')
